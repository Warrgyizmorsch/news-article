                        ...
                        <div class="row align-items-center g-5">
                            ...
                            <div class="col-lg-8 col-xl-7">
                                <div style="aspect-ratio: 16/9; overflow: hidden; border: 1px solid #e5e7eb;">
                                    ...
                                    @if($latestArticle->pdf_file)
                                        <a href="{{ asset('storage/' . $latestArticle->pdf_file) }}" target="_blank" class="hover-zoom-img">
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="custom-news-card"
                                    ...
                                    <div class="card-thumb" style="aspect-ratio: 16/10; overflow: hidden; flex-shrink: 0;">
                                        ...
                                        @if($article->pdf_file)
                                            <a href="{{ asset('storage/' . $article->pdf_file) }}" target="_blank" class="hover-zoom-img">
                                        ...
                                        @else
                                            <div class="hover-zoom-img" style="cursor: default;">
                                                <img src="{{ $article->featured_image ? asset('storage/' . $article->featured_image) : asset('assets/images/default/news-placeholder.webp') }}"
                                                    alt="{{ $article->title }}" style="width: 100%; height: 100%; object-fit: contain;">
                                            </div>
                                        @endif
                                    ...
                                    <div class="card-content"
                                        ...
                                        <div class="card-footer" style="margin-top: auto;">
                                            ...
                                            @else
                                                <span style="color: #9ca3af; font-size: 14px;">Not Available</span>
                                            @endif
