...
@section('content')
    ...
    $readingTime = ceil($wordCount / 200);
                                                  ...
                                                  <p class="right-text">
                                                      ...
                                                      @if($article->pdf_file)
                                                          <a class="rs-btn has-text has-icon" href="{{ asset('storage/' . $article->pdf_file) }}" target="_blank">View
                                                            <span class="icon-box">
    ...
    // $remaining = str_replace($preview, '', $cleanContent);
                                            ...
                                            <div class="rs-author-box">
                                                <div class="rs-author-info">
                                                    <h4 style="font-style: italic;">By <span>{{ $article->auther ?? 'Editorial Staff' }}</span></h4>
