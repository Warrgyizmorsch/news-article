                    ...
                    <div class="rs-login-wrapper text-center">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="rs-login-meta d-flex justify-content-between flex-wrap gap-10 mb-20">
                                ...
                                <div class="rs-login-forgot">
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}" class="rs-login-link">
                                            Forgot Password?
                                        </a>
                                    @endif
                                </div>
                            ...
                            <div class="rs-login-btn">
                                <button type="submit" class="rs-btn hover-white">Sign in</button>
                            </div>
                        </form>
                        ...
                        <div class="rs-login-label text-center">
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="rs-login-link"> Sign up</a>
                            @endif
                        </div>
                    </div>
                </div>
