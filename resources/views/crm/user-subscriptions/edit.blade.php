<x-crm.layout.app>
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit User Subscription</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('user-subscriptions.index') }}">User Subscription List</a></li>
    ...
    <div class="crm-page-container">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user-subscriptions.update', $subscription->id) }}" method="POST">
                    @csrf
                        ...
                        <div class="col-lg-9">
                            <select name="subscription_plan_id" id="subscription_plan_id" class="form-select" required>
                                ...
                                @foreach($plans as $plan)
                                    <option value="{{ $plan->id }}" data-duration="{{ $plan->duration_days }}" {{ old('subscription_plan_id', $subscription->subscription_plan_id) == $plan->id ? 'selected' : '' }}>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-lg-9">
                            <input type="date" name="end_date" id="end_date" class="form-control"
                                value="{{ old('end_date', $subscription->end_date) }}" required>
                            @error('end_date')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
