                        ...
                        <div class="rs-footer-widget-content">
                            ...
                            <div class="rs-footer-widget-social">
                                <div class="rs-theme-social theme-social">
                                    <a href="https://www.facebook.com/democracyasia/" target="_blank"><svg width="14" height="22" viewBox="0 0 14 22" fill="none"
                                    ...
                                    <a href="https://www.instagram.com/democracyasiaofficial/?hl=en" target="_blank"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="https://x.com/Democracyasia" target="_blank"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="https://www.linkedin.com/company/democracy-asia/about/?viewAsMember=true" target="_blank"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="https://in.pinterest.com/democracyasia/_saved/" target="_blank">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M12 0C5.372 0 0 5.372 0 12c0 5.084 3.163 9.427 7.627 11.174-.106-.949-.2-2.406.042-3.442.218-.93 1.402-5.926 1.402-5.926s-.357-.714-.357-1.768c0-1.655.96-2.893 2.156-2.893 1.017 0 1.507.764 1.507 1.68 0 1.024-.652 2.553-.988 3.973-.281 1.186.595 2.152 1.765 2.152 2.118 0 3.744-2.234 3.744-5.456 0-2.851-2.048-4.848-4.971-4.848-3.388 0-5.381 2.541-5.381 5.169 0 1.024.394 2.124.887 2.719.098.119.112.223.083.344-.091.379-.293 1.186-.333 1.352-.052.223-.173.27-.4.163-1.492-.695-2.424-2.876-2.424-4.63 0-3.771 2.739-7.234 7.9-7.234 4.145 0 7.368 2.955 7.368 6.906 0 4.123-2.599 7.442-6.209 7.442-1.212 0-2.352-.63-2.74-1.374l-.745 2.84c-.27 1.04-1.001 2.341-1.49 3.136C9.98 23.854 10.978 24 12 24c6.628 0 12-5.372 12-12S18.628 0 12 0z"
                                                fill="white" />
                                        </svg>
                                    </a>
                                    ...
                                    <a href="https://www.youtube.com/@democracyasiaofficial" target="_blank">
                                        <svg width="20" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M23.498 6.186a2.996 2.996 0 0 0-2.11-2.12C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.388.566a2.996 2.996 0 0 0-2.11 2.12C0 8.07 0 12 0 12s0 3.93.502 5.814a2.996 2.996 0 0 0 2.11 2.12C4.5 20.5 12 20.5 12 20.5s7.5 0 9.388-.566a2.996 2.996 0 0 0 2.11-2.12C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.75 15.02V8.98L15.75 12l-6 3.02z"
                                                fill="white" />
                                        </svg>
                                    </a>
                                </div>
                            ...
                            <div class="rs-post-small rs-post-small-seven">
                                ...
                                @forelse($footerRecentPosts as $post)
                                    <div class="rs-post-small-item">
                                        <div class="rs-post-small-thumb" style="min-width: 90px; max-width: 65px;">
