  ...
  id="daNewsletterModal">
    ...
    <div class="da-newsletter-dialog">
        ...
        <div class="da-newsletter-left">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/007/615/486/small/text-subscribe-now-appearing-behind-torn-brown-paper-top-view-photo.jpg"
                alt="Subscribe">
        </div>
        ...
        <div class="da-newsletter-right">
            ...
            @if(session('newsletter_success'))
              <div class="newsletter-success-box">
                ...
                <button onclick="document.getElementById('daNewsletterModal').classList.remove('active')" class="da-newsletter-btn">
                  Continue Reading
                </button>
