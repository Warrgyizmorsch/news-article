                        ...
                        @if($heroCenter)
                            <div class="rs-post-overlay rs-post-overlay-one">
                                <a href="{{ route('news.show', $heroCenter->slug) }}">
                                    <div class="rs-post-overlay-bg-thumb" style="background-position: center;"
                                        data-background="{{ $heroCenter->featured_image ? asset('storage/' . $heroCenter->featured_image) : asset('assets/images/default/news-placeholder.webp') }}">
                                    </div>
                                </a>
                                <div class="rs-post-overlay-content">
                                    ...
                                    <h3 class="rs-post-overlay-title is-white underline">
                                        <a href="{{ route('news.show', $heroCenter->slug) }}">
                                            {{ \Illuminate\Support\Str::limit($heroCenter->title, 50) }}
                                        </a>
                                    </h3>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <span class="rs-meta">
                                                    ...
                                                    <span>{{ number_format($heroCenter->views ?? 0) }} Views</span>
                                                </span>
                                            </li>
                                            <li>
                                                <span class="rs-meta">
                                                    ...
                                                    <span>{{ $heroCenter->published_at ? $heroCenter->published_at->format('M d, Y') : '' }}</span>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        @else
                            <div class="rs-post-overlay rs-post-overlay-one">
                                <div class="rs-post-overlay-bg-thumb"
                                    data-background="{{ asset('assets/images/default/news-placeholder.webp') }}">
                                </div>
                                <div class="rs-post-overlay-content text-center">
                                    <div class="rs-post-tag-two">
                                        <a href="javascript:void(0)" class="post-tag is-white">News</a>
                                    </div>
                                    <h3 class="rs-post-overlay-title is-white">No featured article found</h3>
                                    <p class="text-white mb-0">Featured content will appear here once articles are published.
                                    </p>
                                </div>
                            </div>
                        @endif
            ...
            <div class="row section-title-space align-items-center g-5">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="section-btn">
                        <a class="rs-btn has-text has-icon is-text-white" href="{{ route('news.index') }}">View All
                            <span class="icon-box">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <span class="rs-meta">
                                                    ...
                                                    <span>{{ number_format($breakingBottom[0]->views ?? 0) }} Views</span>
                                                </span>
                                            </li>
                                            <li>
                                                <span class="rs-meta">
                                                    ...
                                                    <span>{{ $breakingBottom[0]->published_at ? $breakingBottom[0]->published_at->format('M d, Y') : '' }}</span>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <span class="rs-meta">
                                                    ...
                                                    <span>{{ number_format($breakingBottom[1]->views ?? 0) }} Views</span>
                                                </span>
                                            </li>
                                            <li>
                                                <span class="rs-meta">
                                                    ...
                                                    <span>{{ $breakingBottom[1]->published_at ? $breakingBottom[1]->published_at->format('M d, Y') : '' }}</span>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="row g-5">
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="rs-trending-stories-btn text-center mt-40">
                        <a class="rs-btn has-icon has-bg-white" href="{{ route('news.index') }}">Load More News
                    ...
                    <div class="{{ count($categoryArticles) > 1 ? 'col-xl-4' : 'col-xl-12' }}">
                        <div class="rs-post-overlay rs-post-overlay-one featured-category-post">
                            ...
                            <div class="rs-post-overlay-content">
                                <div class="rs-post-tag-two">
                                    <a href="javascript:void(0)" class="post-tag is-white">
                                        {{ $categoryArticles[0]->category->name ?? ($selectedCategory->name ?? 'News') }}
                                    </a>
                                </div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <span class="rs-meta">
                                                ...
                                                <span>{{ number_format($categoryArticles[0]->views ?? 0) }} Views</span>
                                            </span>
                                        </li>
                                        <li>
                                            <span class="rs-meta">
                                                ...
                                                <span>
                                                    {{ $categoryArticles[0]->published_at ? $categoryArticles[0]->published_at->format('M d, Y') : '' }}
                                                </span>
                                            </span>
                                        </li>
                                    </ul>
                                        ...
                                        @if(isset($categoryArticles[$i]))
                                            ...
                                            <div class="rs-post-small">
                                                ...
                                                <div class="rs-post-small-content">
                                                    <div class="rs-post-tag-two">
                                                        <a href="javascript:void(0)" class="post-tag">
                                                            {{ $article->category->name ?? ($selectedCategory->name ?? 'News') }}
                                                        </a>
                                                    </div>
                                                    <h6 class="rs-post-small-title underline">
                                                        <a href="{{ route('news.show', $article->slug) }}">
