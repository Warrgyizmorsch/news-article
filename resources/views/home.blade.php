...
@section('content')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const extraArticles = @json($heroExtra);

            if (extraArticles.length === 0) return;
            ...
            setInterval(() => {
                ...
                if (!extraArticles[index]) index = 0;

                const article = extraArticles[index];

                const target = Math.random() > 0.5 ? leftContainer : rightContainer;
            ...
            <div class="row g-5">
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="rs-trending-stories-btn text-center mt-40">
                        <a class="rs-btn has-icon has-bg-white" href="{{ route('category.show', $politicsCategory->slug ?? 'politics') }}">Load More News
