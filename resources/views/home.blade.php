    ...
    @php
        $videoNews = [
            ...
            [
                ...
                // "image" => "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtm-lGEbdkuSJinqxSi-tZCZfvrG96xgvEmg&s",
            ],
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="rs-post-video rs-post-video-one">
                        <div class="rs-post-video-item">
                            <div class="rs-post-video-thumb position-relative" id="featuredVideo">
                                <img src="{{ !empty($mainVideo['image'])
        ? $mainVideo['image']
        : 'https://img.youtube.com/vi/' . $mainId . '/maxresdefault.jpg' }}" style="width:100%;border-radius:6px"
                                    id="featuredThumbnail">
